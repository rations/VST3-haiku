...
//
// Host-side copy of the interface header; the canonical version lives in the
// NAMku project (source/inamfileloader.h). The interface is a frozen ABI —
// any change there must bump the IID, and this copy must be kept in sync.
//
